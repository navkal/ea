...
function downSampleControlsEnable( tEvent )
{
  ...
  // Show/hide Zoom radio button
  $( "#downSampleByZoom" ).parent().css( "display", zoomRangeIsNull() ? "none" : "inline" );
  ...
  $( "#zoom" ).css( "display", bByZoom ? "block" : "none" );
...
function plotDownSampleToDefault()
{
  $( "#downSampleAuto" ).prop( "checked", true );
  $( "#downSampleManual" ).prop( "checked", false );
  $( "#downSampleByZoom" ).prop( "checked", false );
...
function plotDownSampleToRange()
{
