...
function plotBindEvents( tPlot, tEventHolder )
{
  ...
  $( ".collapse" ).on( "shown.bs.collapse", onCollapseShow );
  $( ".collapse" ).on( "hidden.bs.collapse", onCollapseHide );
}

function onCollapseShow( tEvent )
{
  $(this).parent().find( ".glyphicon-plus" ).removeClass( "glyphicon-plus" ).addClass( "glyphicon-minus" );
  var height = Math.max( 350, parseInt( $( "#plotview" ).css( "height" ) ) - 100 );
  $( "#plotview" ).css( "height", height.toString() + "px" );
}

function onCollapseHide( tEvent )
{
  $(this).parent().find( ".glyphicon-minus" ).removeClass( "glyphicon-minus" ).addClass( "glyphicon-plus" );
  var height = parseInt( $( "#plotview" ).css( "height" ) ) + 100;
  $( "#plotview" ).css( "height", height.toString() + "px" );
}
