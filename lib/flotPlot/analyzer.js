...
function showTooltip( tItem )
{
    ...
    var sTime =  makeTimestampString( tItem.datapoint[0] );
...
function downSampleControlsEnable( tEvent )
{
  ...
  $( "#deselectRange" ).prop( "disabled", zoomRangeIsNull() );
...
function zoomStatusUpdate()
{
  ...
  $( "#timestampFrom" ).text( makeTimestampString( timestampFrom ) );
  $( "#timestampTo" ).text( makeTimestampString( timestampTo ) );
}

function makeTimestampString( timestamp )
{
