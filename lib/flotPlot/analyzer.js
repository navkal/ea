...
function downSampleControlsEnable()
{
  ...
  // Show/hide Zoom radio button and optionally deselect
  $( "#downSampleByZoom" ).parent().css( "display", zoomRangeIsNull() ? "none" : "inline" );
  bByZoom = $( "#downSampleByZoom" ).prop( "checked" );
  if ( bByZoom && zoomRangeIsNull() )
  {
  ...
  bManual = $( "#downSampleManual" ).prop( "checked" );
  ...
  $( "#pattern" ).css( "display", g_bDownSampleAuto ? "none" : "block" );/////////////fake
