...
{
  $( "#downSampleControls .has-error" ).removeClass( "has-error" );

  // Enable/disable zoom-to-selected-range button
  $( "#downSampleToRange" ).prop( "disabled", zoomRangeIsNull() );
...
function plotDownSample()
{
    ...
    g_sDownSampleModePrev = g_sDownSampleMode;
    g_sDownSampleMode = $( "#downSampleControls input:radio[name='downSampleMode']:checked" ).val();
...
function plotDownSampleToFullRange()
{
  ...
  $( "#downSampleManual" ).prop( "checked", false );
  $( "#downSampleByZoom" ).prop( "checked", false );
  g_sDownSampleMode = DOWNSAMPLEMODE_AUTO;
...
function plotDownSampleToSelectedRange()
{
  ...
  g_sDownSampleMode = DOWNSAMPLEMODE_ZOOM;
  $( "#downSampleDensity" ).val( "" );
  $( "#downSampleShow" ).val( g_tZoomRange.xaxis.maxindex - g_tZoomRange.xaxis.minindex + 1 );
  $( "#downSampleHide" ).val( g_aSeries[0].length - g_tZoomRange.xaxis.maxindex - 1 );
  $( "#downSampleOffset" ).val( g_tZoomRange.xaxis.minindex );
  ...
  g_aDownSampleStack.push(
    {
      auto: $( "#downSampleAuto" ).prop( "checked" ),
      manual: $( "#downSampleManual" ).prop( "checked" ),
      zoom: $( "#downSampleByZoom" ).prop( "checked" ),
      mode: g_sDownSampleMode,
      density: $( "#downSampleDensity" ).val(),
...
function plotDownSampleToPrevious()
{
  var tDownSample = g_aDownSampleStack.pop();
  $( "#downSampleAuto" ).prop( "checked", tDownSample.auto );
  $( "#downSampleManual" ).prop( "checked", tDownSample.manual );
  $( "#downSampleByZoom" ).prop( "checked", tDownSample.zoom );
  g_sDownSampleMode = tDownSample.mode;
  $( "#downSampleDensity" ).val( tDownSample.density );
