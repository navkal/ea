...
{
  if ( tEvent.timeStamp != g_tEventTimeStamps.collapseShow )
  {
    g_tEventTimeStamps.collapseShow = tEvent.timeStamp;
...
{
  if ( tEvent.timeStamp != g_tEventTimeStamps.collapseHide )
  {
    g_tEventTimeStamps.collapseHide = tEvent.timeStamp;
