...
var g_bDownSampleAuto = true;
var g_bDownSampleAutoPrev = null;
var g_bDownSampleByZoom = null;
...
function plotDraw( tEvent )
{
   ...
   if ( g_bDownSampleByZoom )
   {
     zoomRangeSet( null );
     g_bDownSampleByZoom = false;
   }
...
function downSampleControlsEnable( tEvent )
{
  ...
  $( "#density" ).css( "display", $( "#downSampleAuto" ).prop( "checked" ) ? "block" : "none" );
...
function plotDownSample()
{
  ...
  g_bDownSampleByZoom = $( "#downSampleByZoom" ).prop( "checked" );
