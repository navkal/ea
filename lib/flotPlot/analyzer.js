...
function plotDownSample( bReset )
{
    ...
    if ( bValidOffset && bValidDensity && bValidShow && bValidHide )
    {
        ...
        if ( ( g_sDownSampleMode != g_sDownSampleModePrev ) || bReset || ( iDensity != g_iDownSampleDensity ) || ( iOffset != g_iDownSampleOffset ) || ( iShow != g_iDownSampleShow ) || ( iHide != g_iDownSampleHide ) )
        {
